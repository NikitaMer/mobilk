					...
					<tr id="<?=$arItem["ID"]?>">
						...
						?>
							<td class="control">
								...
								if ($bDeleteColumn):
								?>
									<a class="sale_delete" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>" title="<?=GetMessage("SALE_DELETE")?>"></a><br />
								<?
								endif;
								if ($bDelayColumn):
								?>
									<a class="sale_delay" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>" title="<?=GetMessage("SALE_DELAY")?>"></a>
								<?
								endif;
								?>
							</td>
	...
	<div class="bx_ordercart_order_pay">
		...
		?>
			<div class="bx_ordercart_coupon">
				<input type="text" id="coupon" name="COUPON" value="" placeholder="<?=GetMessage("STB_COUPON_PROMT")?>" onchange="enterCoupon();"><a class="bx_bt_button bx_big" href="javascript:void(0)" onclick="enterCoupon();" title="<?=GetMessage('SALE_COUPON_APPLY_TITLE'); ?>"><?=GetMessage('SALE_COUPON_APPLY'); ?></a>
			</div><?
