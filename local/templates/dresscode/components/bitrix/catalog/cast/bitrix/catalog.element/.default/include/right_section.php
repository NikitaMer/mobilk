	<div class="mainTool">
		...
		<div class="row">
			<?if(!empty($arResult["MIN_PRICE"])):?>
				<a href="#" class="addCart changeID changeQty changeCart<?if($arResult["CAN_BUY"] === false || $arResult["CAN_BUY"] === "N"):?> disabled<?endif;?>" data-id="<?=$arResult["ID"]?>" data-quantity="<?=$arResult["BASKET_STEP"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ADDCART_LABEL")?>" class="icon"><?=GetMessage("ADDCART_LABEL")?></a>
			<?else:?>
				<a href="#" class="addCart changeID changeQty changeCart disabled requestPrice" data-id="<?=$arResult["ID"]?>" data-quantity="<?=$arResult["BASKET_STEP"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/request.png" alt="<?=GetMessage("REQUEST_PRICE_BUTTON_LABEL")?>" class="icon"><?=GetMessage("REQUEST_PRICE_BUTTON_LABEL")?></a>
			<?endif;?>
		</div>
		<div class="qtyBlock">
            <label class="label"><?=GetMessage("QUANTITY_LABEL")?> </label> <a href="#" class="minus"></a><input type="text" class="qty" value="<?=$arResult["BASKET_STEP"]?>" data-step="<?=$arResult["BASKET_STEP"]?>" data-max-quantity="<?=$arResult["CATALOG_QUANTITY"]?>" data-enable-trace="<?=(($arResult["CATALOG_QUANTITY_TRACE"] == "Y" && $arResult["CATALOG_CAN_BUY_ZERO"] == "N") ? "Y" : "N")?>"><a href="#" class="plus"></a>
        </div>
	</div>
