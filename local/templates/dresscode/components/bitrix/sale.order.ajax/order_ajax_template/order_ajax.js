		...
		show: function(node)
		{
			...
			switch (node.id)
			{
				...
				case this.regionBlockNode.id:
                    ...
                    $("div#bx-soa-region .bx-soa-more-btn a.pull-right").attr("onclick", "ga('send','pageview','/nextregion/');");
					break;
				case this.deliveryBlockNode.id:
					this.editActiveDeliveryBlock(true);
                    $("div#bx-soa-delivery .bx-soa-more-btn a.pull-right").attr("onclick", "ga('send','pageview','/nextdelivery/');");
					break;
				case this.paySystemBlockNode.id:
					this.editActivePaySystemBlock(true);
                    $("div#bx-soa-paysystem .bx-soa-more-btn a.pull-right").attr("onclick", "ga('send','pageview','/nextpayment/');");
					break;
				case this.pickUpBlockNode.id:
				...
				case this.propsBlockNode.id:
                    ...
                    $("div#bx-soa-properties .bx-soa-more-btn a.pull-right").attr("onclick", "ga('send','pageview','/nextcustomer/');");
					break;
			}
