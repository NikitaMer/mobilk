...
/**
 * 
 * —оздаем внутренний счет пользовател€ при добавлении его в группу продавцов
 * 
 * @param array $fields
 * @return void
 * */
function createUserBill(&$fields) {
	...
	// получим текущие группы пользовател€
	...
	// если пользовател€ пытаютс€ добавить в группу продавцов, то создадим счет
