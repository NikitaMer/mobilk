		...
		if(!empty($arOrder["BASKET_ITEMS"])){ 
			foreach ($arOrder["BASKET_ITEMS"] as $arItem){
				...
				while ($arComplectItem = $rsComplect->Fetch()){
					$arItem["COMPLECT"]["ITEMS"][$arComplectItem["ITEM_ID"]] = $arComplectItem;
					$arComplectID[$arComplectItem["ITEM_ID"]] = $arComplectItem["ITEM_ID"];
				}

				if(!empty($arComplectID)){
			
					$arItem["COMPLECT"]["RESULT_BASE_PRICE"] = 0;
					$arItem["COMPLECT"]["RESULT_PRICE"] = 0;
					...
					while($obComplectProducts = $rsComplectProducts->GetNextElement()){
						...
						$complectProductFields["PRICE"]["DISCOUNT_PRICE"] = $complectProductFields["PRICE"]["DISCOUNT_PRICE"] * $arItem["COMPLECT"]["ITEMS"][$complectProductFields["ID"]]["QUANTITY"];
						$complectProductFields["PRICE"]["DISCOUNT_PRICE"] -= $complectProductFields["PRICE"]["DISCOUNT_PRICE"] * $arItem["COMPLECT"]["ITEMS"][$complectProductFields["ID"]]["DISCOUNT_PERCENT"] / 100;
						$complectProductFields["PRICE"]["RESULT_PRICE"]["BASE_PRICE"] = $complectProductFields["PRICE"]["RESULT_PRICE"]["BASE_PRICE"] * $arItem["COMPLECT"]["ITEMS"][$complectProductFields["ID"]]["QUANTITY"];
						$arItem["COMPLECT"]["RESULT_PRICE"] += $complectProductFields["PRICE"]["DISCOUNT_PRICE"];
						$arItem["COMPLECT"]["RESULT_BASE_PRICE"] += $complectProductFields["PRICE"]["RESULT_PRICE"]["BASE_PRICE"];
					}
					if($arItem["COMPLECT"]["RESULT_PRICE"] != $arItem["COMPLECT"]["RESULT_BASE_PRICE"]){
						$arItem["~DISCOUNT_PRICE"] = $arItem["COMPLECT"]["RESULT_BASE_PRICE"];
						$arItem["~BASE_PRICE"] = $arItem["COMPLECT"]["RESULT_BASE_PRICE"];
						$arItem["PRICE_FORMATED"] = CurrencyFormat($arItem["COMPLECT"]["RESULT_PRICE"], $OPTION_CURRENCY);;
						$arItem["BASE_PRICE"] =  CurrencyFormat($arItem["COMPLECT"]["RESULT_BASE_PRICE"], $OPTION_CURRENCY);
					}
