...
<?
    ...
    if(!empty($_SESSION["COMPARE_LIST"]["ITEMS"])){
        ...
        $arFilter = array("ID" => $_SESSION["COMPARE_LIST"]["ITEMS"]);
        ...
        while($ob = $res->GetNextElement()){
            ...
            if(!empty($skuElementID)){
                $resMore = CIBlockElement::GetList(Array(), array("ACTIVE_DATE" => "Y", "ACTIVE" => "Y", "ID" => $skuElementID["ID"]), false, false, $arSelect)->GetNextElement();
